...
public class ImportCalendar extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    /**
     * Create the CalendarOption activity.
    ...
    /**
     * An asynchronous task that handles the Google CalendarOption API call.
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        /**
         * Background task to call Google CalendarOption API.
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            for (CalendarListEntry calendar : calendarList.getItems()) {
                ...
                if(!id.contains("group.v.calendar.google.com")) {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            ImportCalendar.REQUEST_AUTHORIZATION);
                } else {
                    CharSequence text = "Ha ocurrido un error:\n"
                ...
                CharSequence text = "Peticion cancelada.";
                int duration = Toast.LENGTH_SHORT;
                Toast toast = Toast.makeText(context,text,duration);
                toast.show();
            }
